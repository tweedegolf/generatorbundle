...
if __name__ == "__main__":
    ...
    dashes.add_argument('-d', '--dashes', action='store_true', help="Add dashes")
    dashes.add_argument('-n', '--no-dashes', action='store_true', help="Do not add dashes")
    parser.add_argument('limits', metavar='n', type=int, default=[8, 12], nargs='*', help="Password limits")
    ...
    word, hyphenated_word = generate_password(int(minl), int(maxl))
    if args.dashes == False and args.no_dashes == False:
        print random.choice([word, hyphenated_word])
    elif args.dashes == True:
